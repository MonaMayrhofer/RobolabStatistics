...
class Erianet:
    def __init__(self, model_path, config: type(NetConfig), input_image_size=(128, 128), insets=(0, 0, 0, 0), input_to_output_stride=2,
                 do_not_init=False, experimental_preprocess=False, load_only_weights=True):
        self.config = config()
