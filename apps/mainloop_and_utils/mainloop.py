...
from robolib.networks.erianet import Erianet, ConvolutionalConfig, ClassicConfig, MultiConvConfig
...
net = Erianet("atnt_2500.model", input_image_size=(96, 128), config=MultiConvConfig)
